# Load datasets
library(dplyr)
adsl <- vroom::vroom("input/ADSL-1.2.0a3.csv")
adtte <- vroom::vroom("input/ADTTE-1.2.0a3.csv")
adlong <- vroom::vroom("input/ADLONG-1.2.0a3.csv")
adevent <- vroom::vroom("input/ADEVENT-1.2.0a3.csv")
# Helpers
